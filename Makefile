...
PROGRAM = iitpave2
SOURCE = iitpave2.cc readinputs.cc LET.cc XipWip.cc besselroots.cc MATLAB_functions.cc
OBJECTS = iitpave2.o readinputs.o LET.o   XipWip.o besselroots.o MATLAB_functions.o
